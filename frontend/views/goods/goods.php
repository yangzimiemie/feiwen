		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$good->imgs[0]->images."?imageView2/2/w/700/h/700"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$good->imgs[0]->images."?imageView2/2/w/350/h/350"?>"/>               <!-- 第一幅图片的中图 -->
						</a>
					</div>
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								...
								<li class="<?=$key>0?"":"cur"?>">
									<a class="<?=$key>0?"":"zoomThumbActive"?>" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: '<?=$img->images."?imageView2/2/w/350/h350"?>',largeimage: '<?=$img->images."?imageView2/2/w/700/h/700"?>'}"><img src="<?=$img->images."?imageView2/2/w/50/h/50"?>"></a>
								</li>
                                <?php endforeach;?>
							</ul>
				...
				<div class="goodsinfo fl ml10">
					<ul>
						...
						<li class="star"><span>商品评分：</span> <strong></strong><a href="">(已有<?=rand(100,9999)?>人评价)</a></li> <!-- 此处的星级切换css即可 默认为5星 star4 表示4星 star3 表示3星 star2表示2星 star1表示1星 -->
					</ul>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<?=backend\models\GoodsDetail::findOne(['goods_id'=>$good->id])->details?>
						</div>
					</div>
					<!-- 商品介绍 end -->
