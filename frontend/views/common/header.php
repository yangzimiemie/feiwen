<div class="header w1210 bc mt15">
    ...
    <div class="logo w1210">
        <h1 class="fl"><a href="<?=\yii\helpers\Url::to(['home/index'])?>"><img src="/images/logo.png" alt="京西商城"></a></h1>
        <!-- 头部搜索 start -->
        <div class="search fl">
    ...
    <div class="nav w1210 bc mt10">
        <!--  商品分类部分 start-->
        <div class="category fl <?=Yii::$app->controller->id."/".Yii::$app->controller->action->id==="home/index"?"":"cat1"?>">
            <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd <?=Yii::$app->controller->id."/".Yii::$app->controller->action->id==="home/index"?"":"none"?>">
                <?php
                foreach (\backend\models\GoodsCate::find()->where(['parent_id'=>0])->all() as $k1=>$v1):
                ?>
                    <div class="cat <?= $k1 == 0 ? "item1" : "" ?>">
                    <h3><a href="<?=\yii\helpers\Url::to(['home/list','id'=>$v1->id])?>"><?=$v1->name?></a> <b></b></h3>
                    <div class="cat_detail">
                    <?php
                    foreach (\backend\models\GoodsCate::find()->where(['parent_id'=>$v1->id])->all() as $k2=>$v2):
                        ?>
